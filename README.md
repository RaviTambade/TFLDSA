...
* 🌻 **Stacks** — for organizing data one above another, just like flower pots in a vertical rack.
...
| Queue       | `queue.c`      | Handling flow of requests and responses.       |
...
Our approach at Transflower is simple:
...
you’ll **think in structures**, **act with logic**, and **code with purpose**.
...
```bash
git clone https://github.com/RaviTambade/TFLDSA.git
cd TFLDSA
```

This brings all the learning materials — every seed of logic — into your workspace.
...
* **macOS / Linux** → GCC is usually pre-installed. You can check using:

```bash
gcc --version
```

If you get a version number, you’re ready to bloom 🌸

### 🌻 Step 3: Compile Your First Program

Try running our simple starter program — `collection.c`.

```bash
gcc collection.c -o collection
./collection
```

If everything is set up correctly, you’ll see an output like:

```
Hello Transflower!
Student Scores: 67, 89, 56, 59, 78
```

That’s your first digital flower blooming! 🌺


### 🌷 Step 4: Explore and Modify

Once you see the output, don’t stop there.
Be curious — change a score, add another student, print averages, or sort the marks.

That’s how we grow our learning — through experimentation.
At **Transflower**, we don’t memorize — we **play**, **observe**, and **connect**.


### 🌹 Step 5: Keep a Learning Journal

Every time you write or modify a program:

* Note **what you tried**,
* **what worked**, and
* **what surprised you**.

This reflective learning habit transforms code into *understanding*.
