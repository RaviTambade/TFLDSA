...
# ✅ **Extended C++ Solution – Complete Stack Implementation (Bookshelf Example)**
...
public:
    ...
    void push(Book theBook) {
        if (top == size - 1) {
            cout << "❌ Overflow! Cannot add more books. Shelf is FULL.\n";
            return;
        }
        top++;
        books[top] = theBook;
        cout << "📘 Pushed: " << theBook.title << endl;
    }

    // POP operation with underflow check
    Book pop() {
        if (top == -1) {
            cout << "❌ Underflow! No books to remove.\n";
            return Book("EMPTY", "NONE");
        }
        Book removedBook = books[top];
        cout << "📕 Popped: " << removedBook.title << endl;
        top--;
        return removedBook;
    }
    ...
    Book peek() {
        if (top == -1) {
            cout << "❌ Shelf is EMPTY. Nothing to peek.\n";
            return Book("EMPTY", "NONE");
        }
        cout << "👀 Top Book: " << books[top].title << endl;
        return books[top];
    }
...
# ✅ **What Students Learn From This Extended Program**
...
# 📘 **The “Applied Bookshelf” Data Structure**

**Imagine I am your mentor**, and today we aren’t just learning *Data Structures*…
We are going to **enter a library**, meet a librarian, and understand how a **Stack** works—
not with boring memory diagrams, but with **real books**.
 

## 🧑‍🏫 **Scene 1: The Library and the Shelf**

I ask the students:

> “You all have seen a bookshelf at home, right?
> Now imagine a special shelf in the library that has a rule:
>
> 👉 *You can only add books on the TOP*
> 👉 *You can only remove books from the TOP*
>
> That’s it.
>
> This is called a **Stack** — Last In, First Out (LIFO).”

Then I show them the Shelf class.

  

## 📚 **Scene 2: The Books Arrive**
...
> “Our shelf can hold only **5 books**.
...
## 🪜 **Scene 3: Adding Books — The PUSH Operation**
...
> “Every time you call `push()`, the librarian climbs a step,
> places the book at the top, and updates the `top` index.”
>
> ✔ Book1 goes to position 0
> ✔ Book2 → position 1
> ✔ … and so on
>
...
> “This shows all books from *top to bottom*,
> just like seeing your actual bookstack.”
 

## 🔻 **Scene 4: Removing Books — The POP Operation**

Now I tell the class:

> “Imagine the librarian removing books for cleaning.
>
> But again — only from the TOP!”
...
> “If the librarian tries to remove a book from an empty shelf,
> the shelf screams again:
>
> ❌ *Underflow! There is no book left to remove!*”

This is the concept of **stack underflow**.

---

## 📖 **Scene 5: Final Display**
...
# 🎯 **Learning Outcome (What Students Now Understand)**

By the end of this story, students understand:

### ✔ What a stack really is

### ✔ Why it is LIFO (Last In, First Out)

### ✔ How PUSH and POP work

### ✔ What overflow and underflow mean

### ✔ How objects (Books) can be stored using a stack

### ✔ How Data Structures help build real applications

It’s no longer theory…
It’s now a **real-life, relatable learning experience**.
